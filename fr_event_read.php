			...
			<?php
				...
				if($_SESSION['fr_person_title']=='Administrator') {
					foreach ($pdo->query($sql) as $row) {
						echo htmlspecialchars($row['lname']) . ', ' . htmlspecialchars($row['fname']) . ' - ' . htmlspecialchars($row['mobile']) . '<br />';
					$countrows++;
					}
				}
				else {
					foreach ($pdo->query($sql) as $row) {
						echo htmlspecialchars($row['lname']) . ', ' . htmlspecialchars($row['fname']) . ' - ' . '<br />';
					$countrows++;
					}
				}
