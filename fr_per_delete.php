			...
			<div class='control-group col-md-6'>
				...
				<?php
					...
					foreach ($pdo->query($sql) as $row) {
						echo Functions::dayMonthDate($row['event_date']) . ': ' . Functions::timeAmPm($row['event_time']) . ' - ' . htmlspecialchars($row['event_location']) . ' - ' . htmlspecialchars($row['event_description']) . '<br />';
					}
				?>
