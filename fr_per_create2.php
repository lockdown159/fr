		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="fr_per_create2.php" method="post" enctype="multipart/form-data">
				...
				<div class="control-group <?php echo !empty($passwordError)?'error':'';?>">
					...
					<div class="controls">
						<input id="password" name="password" type="password"  placeholder="password" value="<?php echo !empty($password)? htmlspecialchars($password):'';?>">
				...
				<div class="control-group <?php echo !empty($pictureError)?'error':'';?>">
					...
					<div class="controls">
						<input name="address" type="text"  placeholder="123 Lane" value="<?php echo !empty($address)? htmlspecialchars($address):'';?>">
				...
				<div class="control-group <?php echo !empty($cityError)?'error':'';?>">
					...
					<div class="controls">
						<input name="city" type="text"  placeholder="Saginaw" value="<?php echo !empty($city)? htmlspecialchars($city):'';?>">
				...
				<div class="control-group <?php echo !empty($stateError)?'error':'';?>">
					...
					<div class="controls">
						<input name="state" type="text"  placeholder="MI" value="<?php echo !empty($state)? htmlspecialchars($state):'';?>">
				...
				<div class="control-group <?php echo !empty($zipcodeError)?'error':'';?>">
					...
					<div class="controls">
						<input name="zipcode" type="text"  placeholder="48603" value="<?php echo !empty($zipcode)? htmlspecialchars($zipcode):'';?>">
